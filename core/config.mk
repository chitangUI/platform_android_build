...
ifneq ($(CHITANG_BUILD),)
include vendor/chitang/config/BoardConfigChitang.mk
endif
...
ifneq ($(CHITANG_BUILD_BUILD),)
ifneq ($(wildcard device/chitang/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/chitang/sepolicy/common/sepolicy.mk)
endif
endif
